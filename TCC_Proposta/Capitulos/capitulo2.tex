...
O PIC32MX795F512L conta também com 5 Timers de 16 bits, sendo que dois pares podem ser combinados para formar dois Timers de 32 bits \cite{microchip:pic32}. Será explicado no capítulo 3 como esses Timers serão utilizados no trabalho.
