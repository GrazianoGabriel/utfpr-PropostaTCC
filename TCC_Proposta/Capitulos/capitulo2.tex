...
A interrupção ocorre quando a amplitude da tensão descresce para um valor menor que 0,1 pu, em um período de até 3 minutos. Algumas de suas principais causas são falhas de equipamento, falhas no sistema de energia e mau funcionamento de controladores \cite{ieee20091159}.
...
O afundamento ocorre quando a tensão decai para um valor entre 0,1 e 0,9 pu (tensão remanescente de 0,1 a 0,9 pu). Esse evento é geralmente associado à falhas no sistema, comutação de cargas pesadas e acionamento de grandes motores \cite{ieee20091159}.
