...
De acordo com o módulo 8 do PRODIST, publicado pela ANEEL, variações de tensão de curta duração são desvios significativos no valor eficaz da tensão em curtos intervalos de tempo. %\cite{ANEEL}
Essas variações podem ser classificadas como momentâneas ou temporárias, como mostra a tabela abaixo:
