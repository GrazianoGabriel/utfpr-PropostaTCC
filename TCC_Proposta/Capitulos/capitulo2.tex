...
Outra característica importante desse microcontrolador é a presença de uma interface de controle de acesso ethernet (MAC) de 10/100 Mbps \cite{microchip:pic32} que, em conjunto com o periférico relógio em tempo real (também presente no microcontrolador), permitirão configurar o dispositivo para funcionar como um servidor, salvando as informações de tipo, duração e hora das ocorrências de eventos na tensão e disponibilizando-as para consulta online 
