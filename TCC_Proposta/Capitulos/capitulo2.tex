...
Os tipos de variações de tensão de curta duração são definidos de acordo com a tabela \ref{tab:tipos}:
...
Outra característica importante desse microcontrolador é a presença de uma interface de controle de acesso ethernet MAC de 10/100 Mbps \cite{microchip:pic32} que, em conjunto com o relógio e calendário em tempo real, permitirão configurar o dispositivo para funcionar como um servidor, salvando as informações de tipo, duração e hora das ocorrências de eventos na tensão e disponibilizando essa informação para consulta online \cite{cerebot:mx7ck}.
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm, height=6cm,keepaspectratio]{./Figuras/VPEAK.png}
